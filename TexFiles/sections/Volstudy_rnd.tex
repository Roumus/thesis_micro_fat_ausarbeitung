...
As shown in Section \ref{sec:res_micgen}, several microstructure models were created with different volume fractions distribution. 
...
For the stress-controlled tests, here we use identical models as before. All parameters remain the same, but now a stress amplitude is applied (see Section \ref{subsec:strain_controlled_rnd}). 
...
However, the ferrite enters the LCF range faster than the 37HRC martensite with increasing stress amplitude. 
