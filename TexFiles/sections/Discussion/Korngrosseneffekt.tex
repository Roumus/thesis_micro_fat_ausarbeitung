...
%	Thus, crack initiation relies primarily on the ferritic phase at all load amplitudes.
	...
	The grain size change affects the local damage in both phases:; due to this, the lifetime of each phase is plotted separately in \autoref{subplt:kg_whole_Wohler}.
...
%	
	...
	\begin{figure}[H]%{0.5\textwidth}
		...
		\end{subfigure}	
		\caption{Lifetime of each phase depending on grain size of the ferritic phase and a strain amplitude of $o.6\%$.}
