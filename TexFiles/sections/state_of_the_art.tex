...
%The physical cause of this behavior is strain hardening, i.e. the increase in dislocation density impedes further dislocation movement.\\
	...
	\subsubsection{Fatigue in metals} \label{sec.FailureFatigue}
		...
		This scatter is visualized schematically in a Woehler curve in Figure \ref{fig:woehlerkurve_scatter} which results after a statistical evaluation of several samples. The diagram plots the stress amplitude over the fatigue time, whereas it describes at which number of cycles a metal tends to fracture.
